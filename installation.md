...
cd bitcore-wallet-service-zelcash
npm install
```
...
```
### Configuration
Configuration for all required modules can be specified in https://github.com/TheTrunk/bitcore-wallet-service-zelcash/blob/master/config.js
...
```javascript
  blockchainExplorerOpts: {
    livenet: {
      provider: 'insight',
      url: 'https://explorer.zelcash.online:443',
    },
    testnet: {
      provider: 'insight',
      url: 'https://testnet.zelcash.online:443',
    },
  }
```
...
```javascript
  emailOpts: {
    ...
    from: 'wallet-service@zelcashbitcore.io',
  }
```
