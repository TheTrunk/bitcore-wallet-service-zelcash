 ...
 * @param {string} opts.coin[='ZEL'] - The coin for this wallet (ZEL).
 * @param {string} opts.network[='livenet'] - The Zelcash network for this wallet.
 ...
 * @param {string} opts.coin[='ZEL'] - The expected coin for this wallet (ZEL).
 ...
 * @param {string} opts.unit - Zelcash unit used to format amounts in notifications.
 */
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['ZEL', 'bit'], value.toLowerCase()); //TODOWHAT is BIT???? is it BCH?
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='ZEL'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'ZEL'] - The coin to estimate fee levels from.
 * @param {string} [opts.network = 'livenet'] - The Zelcash network to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'ZEL'] - The coin for this transaction.
 * @param {string} [opts.network = 'livenet'] - The Zelcash network for this transaction.
